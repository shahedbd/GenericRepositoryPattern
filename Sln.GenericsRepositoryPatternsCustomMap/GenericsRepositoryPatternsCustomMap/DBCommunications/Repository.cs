...
namespace GenericsRepositoryPatternsCustomMap.DBCommunications
{
    public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        ...
        public dynamic PopulateRecord(SqlDataReader sqldatareader, string TableName)
        {
            try
            {
                switch (TableName)
                {
                    case "PersonalInfo": return new RepositoryPersonalInfo(logger).Mapping(sqldatareader);
                    default: return null;
                }
            }
            catch (Exception ex)
